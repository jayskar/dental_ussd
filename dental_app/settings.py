...
# WhiteNoise: serve static files (including Django admin) directly from gunicorn.
# CompressedManifestStaticFilesStorage adds content-hash fingerprinting and
# gzip/brotli compression so browsers cache assets efficiently.
STORAGES = {
    "default": {
